    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(unique=True, max_length=8, verbose_name=b'dni')),
                ...
                ('type_user', models.CharField(blank=True, max_length=2, null=True, verbose_name=b'tipo de usuario', choices=[(b'1', b'alumno'), (b'2', b'docente'), (b'3', b'cajero'), (b'4', b'administrador'), (b'5', b'alumnocursolibre')])),
